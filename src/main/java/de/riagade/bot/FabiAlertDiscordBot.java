...
public class FabiAlertDiscordBot extends A_TimedBot {
	...
	tasks.add(new DailieEventsOverviewMoTask(this, "0 0 9 ? * MON *")); 
	tasks.add(new DailieEventsOverviewTueTask(this, "0 0 9 ? * TUE *")); 
	tasks.add(new DailieEventsOverviewWedTask(this, "0 0 9 ? * WED *"));
	tasks.add(new DailieEventsOverviewThuTask(this, "0 0 9 ? * THU *"));
	tasks.add(new DailieEventsOverviewFriTask(this, "0 0 9 ? * FRI *"));
	tasks.add(new DailieEventsOverviewSatTask(this, "0 0 9 ? * SAT *"));
	tasks.add(new DailieEventsOverviewSunTask(this, "0 0 9 ? * SUN *"));
